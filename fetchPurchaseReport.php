...
$table = '<table><thead><tr><th width=100px>Date</th><th width=300px>Product Name</th><th>Quantity(Kg)</th><th>Price(per Kg)</th><th>Total price(per product)</th></tr></thead><tbody>';
$total = 0;
$product_total = 0;
