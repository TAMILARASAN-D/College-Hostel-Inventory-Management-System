...
<script>
  ...
  printContents = '<h1>Stock Shortage Report</h1>' ;
...
window.location.reload();
  ...
  <script>
    ...
    $.ajax({
      url: 'fetchStockShortageReport.php',
      type: 'POST',
      data: {
...
// Set the width of the container based on the table width
